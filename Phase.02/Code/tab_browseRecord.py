...
class TabBrowseRecord:
    ...
    def setup_ui(self):
        ...
        ttk.Button(self.frame, text="Browse", command=self.browse_files, width=button_width).grid(column=2, row=0,
                                                                                                  padx=5, pady=10)
        ttk.Button(self.frame, text="Record", command=self.record_audio, width=button_width).grid(column=3, row=0,
                                                                                                  padx=3, pady=10)
